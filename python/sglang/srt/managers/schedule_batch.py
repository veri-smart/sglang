...
class ScheduleBatch(ScheduleBatchDisaggregationDecodeMixin):
    ...
    def prepare_for_cached_decode(self):
        ...
        # Allocate memory
        out_cache_loc, req_pool_indices_tensor, req_pool_indices = alloc_for_cached_decode(
            self
        )
